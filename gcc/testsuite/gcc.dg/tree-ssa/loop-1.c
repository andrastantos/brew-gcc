...
/* On Brew, 'foo' gets put in a register, and get called indirectly. It's hard to predict which register is used, so skip the test for now */
/* { dg-skip-if "&foo is in register" { brew-*-* } "*" "" } */
